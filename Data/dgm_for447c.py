try: 
    ...
    print("Final data shape:", df[columns_to_keep].shape, "with true ATE of:", np.mean(df['Y1'] - df['Y0']))


    # Saving data to csv
    df[columns_to_keep].to_csv("statin_sim_data_full_rep.csv", index=False)
